...
def build_inceptionV3(img_shape=(416, 416, 3), n_classes=16, l2_reg=0.,
...
filepath = "wts/inception/inception_v3-crop-after-{epoch:02d}-{val_f1:.2f}.hdf5"
...
model.load_weights('inception_crops+1.h5')
...
model.save_weights('inception_crops+1.h5')
